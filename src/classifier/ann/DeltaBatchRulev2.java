...
public class DeltaBatchRulev2 extends Classifier {
    ...
    public DeltaBatchRulev2() {
        ...
        _isVerbose = true;
        _initialWeight = null;
        setNeuronPerHiddenLayer(new int[] {0});
    }
    ...
    private void setNeuronPerHiddenLayer(int[] neuronPerHiddenLayer) {
